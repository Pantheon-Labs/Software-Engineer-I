...
const Reasoning: NextPage = () => {
  return (
    ...
    <VStack>
      ...
      <Box w='70%' px={'3'} py={'8'}>
        <Heading alignItems={'center'} textShadow='4px 4px #FFA500' size="3xl" color='white' fontFamily={'mono'}>
      ...
      <Box bg='blue.300' w='70%'  px={'3'} py={'3'}>
        ...
        <Text color='white' fontWeight={'bold'}>
          Joining this team would be a great way for me to expand my skills and knowledge at a fast pace.  
